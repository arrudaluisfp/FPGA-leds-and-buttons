...
HD_PWD='C:/Users/arrud/Documents/UPF/10_Semestre/Micro_II/ArtyA7/trab_1/trab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trab_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trab_1.tcl -notrace
